...
public class PlayerInputHandler : MonoBehaviour
{
	...
	{
		return Cursor.lockState == CursorLockMode.Locked && GameManager.Instance?.DisableInput == false;
	}
	...
	{
		return GetMouseOrStickLookAxis(GameConstants.k_MouseAxisNameHorizontal, GameConstants.k_AxisNameJoystickLookHorizontal, invertXAxis);
	}

	public float GetLookInputsVertical()
	{
		return GetMouseOrStickLookAxis(GameConstants.k_MouseAxisNameVertical, GameConstants.k_AxisNameJoystickLookVertical, invertYAxis);
	}
	...
	float GetMouseOrStickLookAxis(string mouseInputName, string stickInputName, bool invert)
	{
		if (CanProcessInput())
		{
